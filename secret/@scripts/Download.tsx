...
export class Download {
    ...
    private jsonFile: string = `${ExternalDirectoryPath}/hentai/list_downloads_hentai.json`;
    ...
    download(uri: string, name: string): Promise<string> {
        return new Promise(async(resolve, reject)=>{
            var options: RNFS.DownloadFileOptions = { fromUrl: uri, toFile: `${ExternalDirectoryPath}/hentai/${name}` };
    ...
    async deleteDownload(index: number) {
        return new Promise(async(resolve)=>{
            ...
            try {
                ...
                await unlink(`${ExternalDirectoryPath}/hentai/${data.idName}-${data.chapter}`);
