...
export class Tab3 extends Component<IProps, IState> {
    ...
    Loading() { return(<View style={styles.verticalAling}><ActivityIndicator animating={true} size='large' color='#ff5131' style={{ marginTop: 16 }}/></View>); }
    ...
    render(): React.ReactNode {
        ...
        return(<View style={{ flex: 2 }}>
            <View style={{ ...styles.header, backgroundColor: (isThemeDark)? CombinedDarkTheme.colors.card : CombinedDefaultTheme.colors.card }}>
